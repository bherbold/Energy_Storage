...
#CSV.write("data/PV_Germany_2019.csv", solar_available)
...
solar_ava_opt = solar_available[1:tfinal,2]*solar_cap_opt
...
for i = 1:tfinal
    ...
    overall_opt = DataFrame(hour= 1:tfinal,Demand_KW = demand_out,Diesel_Capacity_KW = diesel_cap_opt_list, Diesel_generation_in_hour=diesel_gen_opt,Solar_Capacity_KW = solar_cap_opt_list, Solar_available_KW_in_hour = solar_ava_opt,Solar_generation_in_hour=solar_gen_opt,Battery_Energy_Cap_KWh = batt_Ecap_opt_list,  Battery_Power_Cap_KWh = batt_Pcap_opt_list, Battery_dis_charge_KW = batt_operation_opt,Battery_Charge_Cap_KW =batt_charge_opt, Battery_Disharge_Cap_KW =batt_discharge_opt, Battery_SOC =  batt_SOC_opt)
